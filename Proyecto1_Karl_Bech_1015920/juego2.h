...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbl_Dificultad->Visible = false;
			// 
			// dif_lbl
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(765, 190);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(731, 411);
			...
			// ordenarnueva_btn
			// 
			this->ordenarnueva_btn->Location = System::Drawing::Point(765, 114);
...
#pragma endregion
		...
		if (saveFileDialog2->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		   ...
		   void stepss() {
			   if (p1 == 2) {
				   ...
				   {
					   if (choosemode == 1) {
						   step += "Movimiento: En modo: Pila, " + "D(" + (i)+") a " + "P(" + (i)+")" + "\r\n";
					   }
					   else if (choosemode == 2) {
						   step += "Movimiento: En modo: Cola, " + "D(" + (i)+") a " + "P(" + (i)+")" + "\r\n";
					   }
				   }
			   }
			   else if (p1 == 3) {
	...
	private: System::Void ordenarnueva_btn_Click(System::Object^ sender, System::EventArgs^ e) {
		int d, d2 = 0, d3 = 0, d4 = 0, d5 = 0, d6 = 0, d7 = 0, d8 = 0;
		
		
		if (choosemode == 2) {
			int xyz = 1;
			d = todoslosdatos->GetValueAtStart();
			for (int i = 0; i < todoslosdatos->Total(); i++) {
				if (todoslosdatos->GetValue(i) == d) {

				}
				else if (xyz == 1) {
					d2 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 2) {
					d3 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 3) {
					d4 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 4) {
					d5 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 5) {
					d6 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 6) {
					d7 = todoslosdatos->GetValue(i);
					xyz++;
				}
				else if (xyz == 7) {
					d8 = todoslosdatos->GetValue(i);
					xyz++;
				}
			}
			...
			for (int i = 0; i < todoslosdatos->Total(); i++) {
				...
				else if (todoslosdatos->GetValue(i) == d2) {
					lc2->InsertAtEnd(d2);
				}
				else if (todoslosdatos->GetValue(i) == d3) {
					lc3->InsertAtEnd(d3);
				}
				else if (todoslosdatos->GetValue(i) == d4) {
					lc4->InsertAtEnd(d4);
				}
				else if (todoslosdatos->GetValue(i) == d5) {
					lc5->InsertAtEnd(d5);
				}
				else if (todoslosdatos->GetValue(i) == d6) {
					lc6->InsertAtEnd(d6);
				}
				else if (todoslosdatos->GetValue(i) == d7) {
					lc7->InsertAtEnd(d7);
				}
				else if (todoslosdatos->GetValue(i) == d8) {
					lc8->InsertAtEnd(d8);
				}
			}
			colordgv();
